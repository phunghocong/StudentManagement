...
export const findByStudentId = (studentID) => axios.get(`${url}/${studentID}`);
export const getStudentGPA = (studentID) => axios.get(`${url}/gpa/${studentID}`);
export const getStudentGPAYear = (studentID, year) => axios.get(`${url}/gpa/${studentID}&${year}`);
